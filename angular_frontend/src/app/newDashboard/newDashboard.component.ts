...
import { BookingService } from '../booking/all-booking/booking.service';
import { HttpClient } from '@angular/common/http';
import { MatDialog } from '@angular/material/dialog';
import { MatPaginator } from '@angular/material/paginator';
import { MatSort } from '@angular/material/sort';
import { Booking } from '../booking/all-booking/booking.model';
import { DataSource } from '@angular/cdk/collections';
import { MatSnackBar } from '@angular/material/snack-bar';
import { BehaviorSubject, fromEvent, merge, Observable } from 'rxjs';
import { map } from 'rxjs/operators';
import { FormDialogComponent } from '../booking/all-booking/dialogs/form-dialog/form-dialog.component';
import { DeleteDialogComponent } from '../booking/all-booking/dialogs/delete/delete.component';
...
export class NewDashboardComponent implements OnInit {
  ...
  editCall(row) {
    ...
    dialogRef.afterClosed().subscribe((result) => {
      if (result === 1) {
        ...
        this.refreshTable();
        //To add Func from Booking.service
        this.showNotification(
          'black',
  ...
  lock(row){
    this.bookingService.lockStatus(row.email, 'lock');
    this.showNotification(
      'black',
      'The Door Has Successfully Locked...!!!',
      'bottom',
      'center'
    );
  }
  ...
  unlock(row){
     this.bookingService.lockStatus(row.email, 'unlock');
     this.showNotification(
      'black',
      'The Door Has Successfully UnLocked...!!!',
      'bottom',
      'center'
    );
   }
...
export class ExampleDataSource extends DataSource<Booking> {
  ...
  connect(): Observable<Booking[]> {
    ...
    this._exampleDatabase.getAllCheckIns();
    //this._exampleDatabase.bookingStatistics();
